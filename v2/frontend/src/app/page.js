        ...
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-4">
          ...
          {loading ? null : user ? (
            ...
            <div className="flex flex-col items-center gap-3">
              <p className="text-sm text-white/85">Je suis...</p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/login?role=user"
                  className="flex w-28 flex-col items-center gap-1 rounded-xl bg-white/15 px-4 py-3 text-white transition hover:bg-white/25"
                >
                  <span className="text-2xl">👤</span>
                  <span className="text-sm font-medium">Usager</span>
                </Link>
                <Link
              ...
              <Link href="/register" className="text-sm text-white/70 underline">
                Pas encore de compte usager ? S'inscrire
              </Link>
            </div>
          )}
        </div>
